...
문자 또는 한국어 실시간 음성 입력을 OpenRouter로 구조화하고, 사용자가 검토한 견적을 HWPX로 내려받는 웹 서비스입니다.
...
현재 HWPX는 내장된 기본 문서 구조로 생성됩니다. 실제 회사의 표, 로고, 도장, 글꼴 및 페이지 규칙을 그대로 유지하려면 최종 견적서 HWPX 원본을 템플릿으로 연결해야 합니다.
